  ...
  return (
    <div className="relative">
      <motion.button
        ...
        className="flex items-center space-x-2 bg-white/10 backdrop-blur-xl border border-white/20 text-slate-700 px-4 py-2 rounded-full hover:bg-white/20 transition-all duration-300"
      >
        <Globe size={16} />
